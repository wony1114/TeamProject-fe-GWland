...
export const RecomPlace2 = ()=>{
    return <div className="col-md-8">
    <div className="recom-item border">
      <div className="recom-media"><a href="hotels-details.html">
          <div className="pic"><img src="/pic/recomended/1.jpg" data-at2x="pic/recomended/1@2x.jpg" alt/></div></a>
        <div className="location"><i className="flaticon-suntour-map"></i> Istanbul, Turkey</div>
      </div>
      <div className="recom-item-body"><a href="hotels-details.html">
          <h6 className="blog-title">Hotel Bohemians</h6></a>
    ...
    <div className="recom-item border">
      <div className="recom-media"><a href="hotels-details.html">
          <div className="pic"><img src="/pic/recomended/2.jpg" data-at2x="pic/recomended/2@2x.jpg" alt/></div></a>
        <div className="location"><i className="flaticon-suntour-map"></i> Praga, Czech Republic</div>
      </div>
      <div className="recom-item-body"><a href="hotels-details.html">
          <h6 className="blog-title">Easyhotel</h6></a>
    ...
    <div className="recom-item border">
      <div className="recom-media"><a href="hotels-details.html">
          <div className="pic"><img src="/pic/recomended/3.jpg" data-at2x="pic/recomended/3@2x.jpg" alt/></div></a>
        <div className="location"><i className="flaticon-suntour-map"></i> Isle of Colonsay, United...</div>
      </div>
      <div className="recom-item-body"><a href="hotels-details.html">
          <h6 className="blog-title">Dolce Villa</h6></a>
    ...
    <div className="recom-item border">
      <div className="recom-media"><a href="hotels-details.html">
          <div className="pic"><img src="/pic/recomended/4.jpg" data-at2x="pic/recomended/4@2x.jpg" alt/></div></a>
        <div className="location"><i className="flaticon-suntour-map"></i> St. Petersburg, Russia</div>
      </div>
      <div className="recom-item-body"><a href="hotels-details.html">
          <h6 className="blog-title">Hotel Stary Pivovar</h6></a>
        <div className="stars stars-4"></div>
    ...
    <div className="recom-item border">
      <div className="recom-media"><a href="hotels-details.html">
          <div className="pic"><img src="/pic/recomended/5.jpg" data-at2x="pic/recomended/5@2x.jpg" alt/></div></a>
        <div className="location"><i className="flaticon-suntour-map"></i> Vienna, Austria</div>
      </div>
      <div className="recom-item-body"><a href="hotels-details.html">
          <h6 className="blog-title">Grand Hotel Wien</h6></a>
        <div className="stars stars-5"></div>
    ...
    <div className="recom-item border">
      <div className="recom-media"><a href="hotels-details.html">
          <div className="pic"><img src="/pic/recomended/6.jpg" data-at2x="pic/recomended/6@2x.jpg" alt/></div></a>
        <div className="location"><i className="flaticon-suntour-map"></i> Kraków, Poland</div>
      </div>
      <div className="recom-item-body"><a href="hotels-details.html">
          <h6 className="blog-title">Hotel Wit Stwosz</h6></a>
        <div className="stars stars-3"></div>
